...
type ExhibitorModel struct {
	...
	CreatorID  int64         `gorm:"column:creator_id;type:bigint;not null" json:"creator_id"`     // 创建者ID
	Creator    UserModel     `gorm:"foreignKey:CreatorID;references:ID" json:"-"`                  // 创建者
	ActivityID int64         `gorm:"column:activity_id;type:bigint;not null" json:"activity_id"`   // 所属活动ID
