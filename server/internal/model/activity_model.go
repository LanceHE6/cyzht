...
type ActivityModel struct {
	...
	Avatar    string    `gorm:"column:user_avatar;type:varchar(255);" json:"user_avatar"`        // 活动头像
	...
	CreatorID int64     `gorm:"column:creator_id;type:bigint;not null" json:"creator_id,string"` // 活动发起人ID
